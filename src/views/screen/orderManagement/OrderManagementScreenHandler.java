...
public class OrderManagementScreenHandler extends BaseScreenHandler implements Initializable, ItemOrderScreenHandler.OnClickItemOrder {
    ...
    public OrderManagementScreenHandler(Stage stage, String screenPath) throws IOException {
    ...
    public void goToOrderDetail(int id) throws IOException, SQLException {
        OrderDetailsScreenHandler orderDetailScreenHandler = new OrderDetailsScreenHandler(this.stage, Configs.ORDER_DETAIL_ADMIN_PATH, id);
