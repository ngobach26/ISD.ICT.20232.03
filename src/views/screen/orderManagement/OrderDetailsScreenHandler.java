...
public class OrderDetailsScreenHandler extends BaseScreenHandler {
    ...
    public OrderDetailsScreenHandler(Stage stage, String screenPath, int orderId) throws IOException, SQLException {
